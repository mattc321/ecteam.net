...
<div id="projecttitle" class="corner"><div class="corner-text">&nbsp;&nbsp;&nbsp;Project</div></div>
...
<div class="far-right">
	...
	<?php hide($content['field_last_modified_by']); ?>
    <?php print render($content);?>
	<?php //print views_embed_view('task_view', 'block_1', $node->nid); ?>
